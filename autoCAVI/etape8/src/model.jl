...
Compute the second parameter of kappa's law.

# Arguments
- `θ::DenseVector`: one of the cells' parameter, μ or ϕ, for every cells.
- `F::iGMRF`: iGMRF associated with this parameter.
"""
function compKappaParam(θ::DenseVector, F::iGMRF)
    return θ' * F.G.W * θ / 2 + 1/100
end
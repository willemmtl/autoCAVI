...
@testset "model.jl" begin
    ...
    @testset "logfullconditional(θ1; μ, ϕ, μ̄1, ϕ̄1, Fmu, Fphi, data)" begin
        ...
        @test logfullconditional(i, θi, μ=μ, ϕ=ϕ, Fmu=Fmu, Fphi=Fphi, data=data) ≈ (
            - 2 - 6 # loglike GEV
            - .5 * log(2*pi / 20) # Priori de mu

...
Compute the variance derived from the Fisher information.

# Arguments
- `logf::Function`: Log-functional form of the density.
- `x0::Float`: Where to compute the Fisher info (usually the mode).
"""
function fisherVar(logf::Function, x0::Float)
